...
kubectl cp kube-system/"$(kubectl  -n kube-system get pods -o wide | grep cni | awk '{print $1}' | awk 'NR==1{print}')":/kube-ovn/kubectl-ko ./kubectl-ko
chmod +x ./kubectl-ko
sudo install ./kubectl-ko /usr/local/bin
